...
I have to give credit where credit is due. This file comes from a Markdown Cheat Sheet I found in a [separate repository.](https://github.com/im-luka/markdown-cheatsheet/tree/main) I saved a copy on my end just to have a quick reference to markdown when I need it. -Bryce
